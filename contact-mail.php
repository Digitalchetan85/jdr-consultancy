...
try {
    ...
    $mail->Subject = 'Enquiry Details.';
        ...
        $mail->Body   .= "<tr><td><strong>Name:</strong> </td><td>" . strip_tags($_POST['contact-name']) . "</td></tr>";
        $mail->Body   .= "<tr><td><strong>Email:</strong> </td><td>" . strip_tags($_POST['contact-email']) . "</td></tr>";
        $mail->Body   .= "<tr><td><strong>Phone:</strong> </td><td>" . strip_tags($_POST['contact-phone']) . "</td></tr>";
        $mail->Body   .= "<tr><td><strong>Select Visa:</strong> </td><td>" . strip_tags($_POST['contact-selectvisa']) . "</td></tr>";
        $mail->Body   .= "<tr><td><strong>Message:</strong> </td><td>" . strip_tags($_POST['contact-message']) . "</td></tr>";
        $mail->Body   .= "</table>";
        $mail->Body   .= "</body></html>";
