                ...
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                        <div class="coaching-card">
                            ...
                            <div class="coaching-card-body">
                                <h2 class="coaching-card-title"><a href="#" class="title text-decoration-none">IELTS Coaching</a></h2>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                        <div class="coaching-card">
                            ...
                            <div class="coaching-card-body">
                                <h2 class="coaching-card-title"><a href="#" class="title text-decoration-none">PTE Coaching</a></h2>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                        <div class="coaching-card">
                            ...
                            <div class="coaching-card-body">
                                <h2 class="coaching-card-title"><a href="#" class="title text-decoration-none">TOEFL</a></h2>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                        <div class="coaching-card">
                            ...
                            <div class="coaching-card-body">
                                <h2 class="coaching-card-title"><a href="#" class="title text-decoration-none">GRE <small> (Graduate Record Examination)</small></a></h2>
