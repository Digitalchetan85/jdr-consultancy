            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 text-center">
                        <h1 class="page-title">Study in Canada</h1>
                        <p class="page-description">The Canada is a country that needs no introduction.<br> If you desire to achieve your goals, the world is your oyster. </p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Study in Canada</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                        <div class="content-area">
                            ...
                            <p>As a country, Canada is known for being the most welcoming to immigrants. As a tourist destination, it has a wide range of natural beauty, historical places, and a wide range of cultures to explore. It is noted for its modernized and multicultural cities, natural wonders like Rocky Mountain Parks, Niagara Falls, etc., and a variety of outdoor activities including camping, rafting, and kayaking, among others. The only catch is that you'll need a Canada tourist visa to enjoy it all.</p>
                            <p>A visitor to Canada with a valid visit visa may remain in the country for a maximum of six months from the date of issuance. Before the permit expires, you must depart the country.</p>
                            <p>Our visa specialists can assist you at each step of the way to securing your visa.</p>
                            <img src="images/post-img-3.jpg" alt="" class="img-fluid mb30">
                            <h2>Canada Study Visa</h2>
                            <p>Over 600,000 students travel to Canada each year to pursue their academic goals. International students, particularly those from India, choose Canada as one of their top study abroad locations. Affordability and the quality of education are two of the main reasons why students are flocking to study abroad in this country.</p>
                            <p>A study permit granted by the Canadian government is required in order to do so. It is a type of Temporary Resident Visa (TRV) that permits students to study in Canada for a short period of time and often identifies the educational institution and course of study they are attending. </p>
                            <h4 class="">How to apply for Canada study visa</h4>
                            <p>You are required to submit an application to a recognized educational establishment before you apply for a study permit in Canada. Once you've been approved, you may begin the process of obtaining a student visa. You will need to provide some documents in addition to the application, and you will also have to meet all of the requirements set by the Canadian government.</p>
                            <ul class="listnone check-circle">
                                <li>Valid Passport </li>
                                <li>Proof of Acceptance by a Designated Learning Institution </li>
                                <li>Proof of adequate finances to cover tuition and living costs</li>
                                <li>Canadian immigration requires overseas students from India to complete an Immigration Medical Exam.</li>
                                <li>English Language Proficiency Exam Score</li>
                                <li>On the application for a Canadian Study Permit, you have to write an essay about the purpose of your trip and why you chose the school.</li>
                        ...
                        <div class="py-3 py-md-5">
                            <div class="content-area pt-5 pb-5">
                                <h2 class="text-start">Canada Work Visa</h2>
                                <p>An excellent reason for choosing to work in Canada is that the country has one of the most developed economies in the world. The Canadian Work Permit Visa allows business people, permanent employees, temporary workers, students, and others to work in Canada.</p>
                                <!-- <img src="assets/images/post-img-3.jpg" alt="" class="img-fluid mb30"> -->

                                <ul class="listnone check-circle">
                                    <li>An employment offer is typically required prior to applying for a work permit visa.</li>
                                    <li>An employment offer is typically required prior to applying for a work permit visa.</li>

                                </ul>
                                <h4>Federal Skilled Trades Program</h4>
                                <p>The Federal Skilled Trades Program is designed for skilled individuals who seek to become permanent residents based on their qualifications in a skilled trade. In Canada, the Federal Skilled Trades Program is open to trades people from all over the globe who are skilled in plumbing, electrical, construction, maintenance, HVAC, manufacturing, agriculture, and culinary and baking.</p>
                                <h2 class="text-start">Canada Permanent Residency</h2>
                                <p class="">Every year, tens of thousands of individuals attempt to immigrate to Canada in order to get a Canada permanent residency (PR) card.</p>
                                <p class="">Permanent residency (PR) in Canada is a status that grants a person who is not a citizen of Canada the ability to live and work in Canada without any time restriction on their stay. </p>
                                <p class="">This status may be obtained by applying for <b>PR.</b> </p>
                                <p class="">If a foreigner wants to live in Canada permanently, they must fill out an application through one of the many programs offered by Immigration, Refugees, and Citizenship Canada (IRCC).</p>
                                <p class="">Canada has been working steadily to increase the number of applications it approves each year.</p>
                            ...
                            <div class="content-area pt-5 pb-5 ps-2 pe-2 bg-light ">
                                ...
                                <h4></h4>
                                <p>To ensure that the application process goes as easily as possible for you, we provide comprehensive help. Below are our services:</p>
                                <ul class="listnone check-circle">
                                    <li>Checklist for the Documents Required for Immigration to Canada.</li>
                                    <li>Complete the processing of your application.</li>
                                    <li>Filling out applications, submitting paperwork, and other administrative tasks</li>
                                    <li>Follow-up and current status reports</li>
                                    <li>Assistance in relocating to Canada and adjusting to life after arrival is also provided.</li>
                        ...
                        <div class="pb-3 pb-md-5">
                            <div class="content-area pt-5 pb-5">
                                <h2 class="text-center">Courses available in Canada.</h2>
                                <div class="row">
                                    <div class="col-md-4">
                                        <ul class="listnone check-circle">
                                            <li> Dentistry</li>
