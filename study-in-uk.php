            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 text-center">
                        <h1 class="page-title">Study in United Kingdom</h1>
                        <p class="page-description">The United Kingdom is a country that needs no introduction.<br> If you desire to achieve your goals, the world is your oyster. </p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Study in United Kingdom</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                        <div class="content-area">
                            <h2>UK  Standard Visit Visa </h2>
                            <p>Whether it's to see Buckingham Palace or the magnificent Georgian architecture, tourists from across the globe flock to the United Kingdom. An estimated ten of millions of foreign tourists come to the UK each year on what is known as a "Standard Visit Visa".</p>
                            <p>An appointment with VFS is required to submit your paperwork for the UK visit visa. The procedure usually takes between three and four weeks, and once you have the visa in hand, you will be able to remain in the UK for a maximum of six months. </p>
                            ...
                            <p>You may go to the United Kingdom to spend time with friends and family or have some fun.</p>
                            <p>In an effort to improve your chances of being granted the visa, JDR Migration is ready to assist you in completing all of the necessary paperwork and applications.</p>
                            <!-- <img src="images/post-img-3.jpg" alt="" class="img-fluid mb30"> -->
                            <h2>UK Study visa</h2>
                            <p>More than 600,000 students from other countries choose to pursue their education in the UK each year. Students come to this country in droves because it has a world-class education system and a wide range of degrees.</p>
                            <p>Under Tier-4 of the points-based system for UK Student Visa, there are two different types of students:</p>
                            <p><b>Tier 4 (General) Student Visa:</b> This visa category is for students who want to attend a higher education institution in the United Kingdom. In order to apply, you need to be at least 16 years of age!</p>
                            <p><b>Tier 4 (Child) Student Visa:</b> This visa category is for children between the ages of 4 and 15 who want to study in the United Kingdom. Children between the ages of 4 and 15 can only go to private schools that charge a fee.</p>
                            <p>If you're 16 or older and have been accepted into a course by a licensed student sponsor, you may apply for a student visa to study in the United Kingdom. Make sure that you have enough money to sustain yourself and pay for your education. </p>
                            <h4 class="">Documents needed</h4>
                            <p>The following are the required submissions:</p>

                            <ul class="listnone check-circle">
                                <li>Your valid passport</li>
                                <li>An updated bank statement demonstrating enough cash for your course-related expenses throughout your time in residence.</li>
                                <li>Acceptance of Study Confirmation (CAS)</li>
                                <li>Your passport-sized colored photos</li>
                                <li>If necessary, the appropriate medical tests should be performed.</li>
                                <li>An assessment of your personal profile</li>
                                <li>Certificates or official transcripts that have your name, the name of the school, the course title, and the date you got the certificate.</li>
                                <li>Clearance Certificate for the Academic Technology Approval Scheme (ATAS) (if required)</li>
                                <li>If you're under the age of 18 or traveling with dependents, you'll need to provide additional documentation.</li>
                        ...
                        <div class="py-3 py-md-5">
                            ...
                            <h2>UK Employment Visa (UK Tier 2 Visa)</h2>
                                <p>The UK Tier 2 visa scheme is designed to keep the UK competitive by allowing talented workers to come to the country to work. The Tier 2 Shortage Occupation List is a list of jobs that are in short supply in the United Kingdom and hence eligible for long-term visas under this category. On the list, some of the most sought-after careers include those in information technology, banking, education, healthcare, and engineering. </p>
                                <!-- <img src="assets/images/post-img-3.jpg" alt="" class="img-fluid mb30"> -->

                                <p>JDR Migration may help you take advantage of this scarcity of talent in the UK and position yourself for a work visa to the United Kingdom.</p>
                                
                                <h4>Documents required for a UK Tier 2 visa:</h4>


                                <p>As part of the UK Tier 2 visa application, applicants must provide the following documents:</p>

                                <ul class="listnone check-circle">
                                    <li>A Certificate of Sponsorship from an employer that is valid</li>
                                    <li>Present financial and salary information</li>
                                    <li>The passport and travel records of the holder</li>
                                    <li>Proof of your ability to speak and write in English.</li>
                                    <li>Certificate of criminal record</li>
                                    <li>Additional papers to substantiate your claim</li>
                                </ul>
                            </div>
                            <div class="content-area pt-5 pb-5 ps-2 pe-2 bg-light ">
                                ...
                                <ul class="listnone check-circle">
                                    <li>An evaluation of your current situation and your possibilities.</li>
                                    <li>Help with visa application documents..</li>
                                    <li>Prepare and submit your application.</li>
                                    <li>Monitoring applications and liaising with the UK Border Agency.</li>
                                </ul>
                        ...
                        <div class="pb-3 pb-md-5">
                            <div class="content-area pt-5 pb-5">
                                <h2 class="text-center">Courses available in UK.</h2>
                                <div class="row">
                                    <div class="col-md-4">
                                        <ul class="listnone check-circle">
                                            <li> Dentistry</li>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="sidebar sticky-top">
                            <div class="widget widget-quote-form bg-light">
                                <h3 class="form-title">Free UK Assessment</h3>
