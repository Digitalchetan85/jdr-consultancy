...
<div id="navbar" class="sticky-top">
    ...
    <div>
        <!-- /.header classic -->
        <div class="page-header" id="flight">
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                        <h1 class="page-title">Flight Bookings </h1>
                        <p class="page-description">All of our Flight Bookings are done here, and we strive to make the application process as simple as possible. </p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                        <div class="content-area">
                            <h3 class="text-primary">Flight Bookings JDR Migration </h3>
                            <p>After you have overcome all of the challenges of being accepted into your school programs or
landing that job, and after your visa application has been successful, we will assist you in
arranging your flight tickets.</p>
                            <p>At JDR Migration, we provide a wide variety of goods and services, like Flight Ticket Booking
Services, to our valued customers, all of which are backed by our extensive industry experience and knowledge.</p>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                        <div class="sidebar sticky-top">
                            <div class="widget widget-quote-form bg-light">
                                <h3 class="form-title">Free Flight-booking Assessment</h3>
