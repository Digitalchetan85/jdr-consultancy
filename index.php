        ...
        <div class="container">
            <div class="row">
                <div class="offset-xl-2 col-xl-8 offset-lg-2 col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="section-title text-center">
                        <!-- section title start-->
                        <h2>Study Abroad - Choose your country</h2>
                        <p> We Bring Study Migration To Life! </p>
                    </div>
                    <!-- /.section title start-->
                </div>
            </div>
            <div class="space-small pdb0">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                    ...
                    <!-- <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                        <div class="country-img-thumbnail">
                            <div class="country-img"><a href="#"><img src="assets/images/country/Country 7.jpg" alt="France visa immigration" class="img-responsive"></a>
                                {{-- <span class="country-flag-icon"><img src="assets/images/country/France.svg" alt=""></span> --}}
                            </div>
                            <div class="country-content">
                                <h3><a href="#" class="title text-decoration-none">France</a></h3>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                        <div class="country-img-thumbnail">
                            <div class="country-img"><a href="study-in-usa.php"><img src="assets/images/country1/usa.jpg" alt="United Kingdom visa immigration" class="img-responsive"></a>
                                <!-- {{-- <span class="country-flag-icon"><img src="assets/images/country/united-states-of-america.svg" alt=""></span> --}} -->
                            </div>
                            <div class="country-content">
                    ...
                    <!-- <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                        <div class="country-img-thumbnail">
                            ...
                            <div class="country-content">
                                <h3><a href="#" class="title text-decoration-none">Germany</a></h3>
                    ...
                    <!-- <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                        <div class="country-img-thumbnail">
                            ...
                            <div class="country-content">
                                <h3><a href="#" class="title text-decoration-none">Malaysia</a></h3>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-7 col-sm-6 col-12">
                    <h2 class="mb10">Free online assessment</h2>
