...
try {
    ...
    $mail->Subject = 'Enquiry Details.';
        ...
        $mail->Body   .= "<tr><td><strong>Name:</strong> </td><td>" . strip_tags($_POST['study-usa-name']) . "</td></tr>";
        $mail->Body   .= "<tr><td><strong>Email:</strong> </td><td>" . strip_tags($_POST['study-usa-email']) . "</td></tr>";
        $mail->Body   .= "<tr><td><strong>Phone:</strong> </td><td>" . strip_tags($_POST['study-usa-phone']) . "</td></tr>";
        $mail->Body   .= "<tr><td><strong>Select Visa:</strong> </td><td>" . strip_tags($_POST['study-usa-selectvisa']) . "</td></tr>";
        $mail->Body   .= "<tr><td><strong>Message:</strong> </td><td>" . strip_tags($_POST['study-usa-message']) . "</td></tr>";
        $mail->Body   .= "</table>";
        $mail->Body   .= "</body></html>";
